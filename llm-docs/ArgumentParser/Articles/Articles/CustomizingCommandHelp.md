...
In addition to configuring the command name and subcommands, as described in [CommandsAndSubcommands](CommandsAndSubcommands.md), you can also configure a command's help text by providing an abstract, discussion, or custom usage string.
